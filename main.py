...
clock = Tk()
title = "* * * * *  Digital clock  * * * * *"
modified_string = title.rjust(len(title) + 118)
clock.title(modified_string)
clock.geometry('1000x500')
clock.config(bg='yellow')

# time

lab_hr = Label(clock, text='12', font=('Time New Roman', 60, 'bold'), bg='red', fg='white')
lab_hr.place(x=120, y=50, height=110, width=100)
lab_hr_txt = Label(clock, text='Hour', font=('Time New Roman', 30, 'bold'), bg='red', fg='white')
lab_hr_txt.place(x=120, y=190, height=40, width=100)

lab_min = Label(clock, text='12', font=('Time New Roman', 60, 'bold'), bg='red', fg='white')
lab_min.place(x=340, y=50, height=110, width=100)
lab_min_txt = Label(clock, text='Min', font=('Time New Roman', 30, 'bold'), bg='red', fg='white')
lab_min_txt.place(x=340, y=190, height=40, width=100)

lab_sec = Label(clock, text='12', font=('Time New Roman', 60, 'bold'), bg='red', fg='white')
lab_sec.place(x=560, y=50, height=110, width=100)
lab_sec_txt = Label(clock, text='Sec', font=('Time New Roman', 30, 'bold'), bg='red', fg='white')
lab_sec_txt.place(x=560, y=190, height=40, width=100)

lab_am = Label(clock, text='AM', font=('Time New Roman', 45, 'bold'), bg='red', fg='white')
...
lab_date = Label(clock, text='12', font=('Time New Roman', 60, 'bold'), bg='red', fg='white')
lab_date.place(x=120, y=270, height=110, width=100)
lab_date_txt = Label(clock, text='Date', font=('Time New Roman', 30, 'bold'), bg='red', fg='white')
lab_date_txt.place(x=120, y=410, height=40, width=100)

lab_month = Label(clock, text='12', font=('Time New Roman', 60, 'bold'), bg='red', fg='white')
...
lab_year = Label(clock, text='12', font=('Time New Roman', 60, 'bold'), bg='red', fg='white')
lab_year.place(x=560, y=270, height=110, width=100)
lab_year_txt = Label(clock, text='Year', font=('Time New Roman', 30, 'bold'), bg='red', fg='white')
lab_year_txt.place(x=560, y=410, height=40, width=100)

lab_day = Label(clock, text='AM', font=('Time New Roman', 45, 'bold'), bg='red', fg='white')
